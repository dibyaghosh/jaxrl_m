...
def default_wandb_config():
    ...
    group_name = ml_collections.config_dict.FieldReference(None, field_type=str) # Group name    
    ...
    experiment_name = ml_collections.config_dict.FieldReference(None, field_type=str) # Group name
